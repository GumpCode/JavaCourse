...
public class CompressOperation {
     ...
     * @throws Exception 
     */  
    public static void zip(File srcFile, File destFile) throws Exception {  
     ...
     * @throws Exception 
     */  
    public static void zip(File srcFile, String destPath) throws Exception {  
     ...
     * @throws Exception 
     */  
    private static void zip(File srcFile, ZipOutputStream zos,  
